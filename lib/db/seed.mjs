    ...
    for (const product of seed.products) {
      ...
      const result = await client.query(
        ...
        [product.name, product.slug, product.price, product.packSize, product.status,
          ...
          product.availabilityOverride, product.listingOverride, product.publishStatus,
    ...
    for (const line of seed.saleLines) {
      ...
      await client.query(
        ...
        [productId, line.stockCode, line.seedForm, line.seedGrade, line.packKg,
          line.packUnit, line.availability, line.priceDisplay, line.isDefault, line.sortOrder],
      );
    }
