...
export const metadata: Metadata = {
  title: "2026 Pasture Seed Guide | IH Seeds",
  description: "Download the 2026 IH Seeds pasture seed guide for Western Australian sowing rates, rainfall zones and species notes.",
};
      ...
      <section style={{ background: "#FFFFFF" }}>
        <div className="page-hero-grid" style={{ maxWidth: 1180, margin: "0 auto", padding: "96px 40px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          ...
          <div style={{ borderRadius: 24, overflow: "hidden", boxShadow: "0 20px 40px rgba(29,40,28,0.15)", background: "var(--sage)" }}>
            <img src="https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=900&q=80" alt="Seed Guide Cover" style={{ display: "block", width: "100%", height: 500, objectFit: "cover" }} />
          </div>
        </div>
      </section>
